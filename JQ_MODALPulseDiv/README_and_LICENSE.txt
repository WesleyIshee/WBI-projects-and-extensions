...
One for the open called wbiDivPulsateOpenModal(). it expects 4 parameters to be passed in:
...
example:  onclick="wbiDivPulsateOpenModal('divPulsateOuter','divPulsateContent',600,800)"
